...
describe('comparePrompt', () => {
  it('generates a valid message array for costs focus', async () => {
    const args = comparePrompt.args!.parse({
      school_names: 'University of Washington, University of Oregon',
      focus: 'costs',
    });
    const messages = await comparePrompt.generate(args);
  ...
  it('generates a valid message array for outcomes focus', async () => {
    const args = comparePrompt.args!.parse({
  ...
  it('generates a valid message array for programs focus', async () => {
    const args = comparePrompt.args!.parse({
  ...
  it('includes school names in the generated message', async () => {
    const args = comparePrompt.args!.parse({
  ...
  it('includes scorecard_value_analysis for costs and outcomes focus (not programs)', async () => {
